...
const DEFAULT_IMAGES: ImageItem[] = [
    ...
    { src: SSMS, alt: "SQL Server Management Studio" },
    { src: Katalon, alt: "Katalon Studio" },
    { src: IDA, alt: "IDA Freeware" },
    { src: Nmap, alt: "Nmap / Zenmap" },
    ...
    { src: CiscoPacketTracer, alt: "Cisco Packet Tracer" },
];
